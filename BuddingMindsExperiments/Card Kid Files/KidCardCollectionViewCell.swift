...
class KidCardCollectionViewCell: UICollectionViewCell {
    ...
    func setCard(_ card: KidCard) {
        if !card.greyedOut {
            self.card = card
            
            frontImageView.image = UIImage(named: card.imageName)
            backImageView.image = UIImage(named: "card back_Kid.png")
            ...
            backImageView.image = UIImage(named: "card back greyed out_Kid.png")
        }
    }
    ...
    func flip(phase: Int) {
        if phase != 5 && phase != 6 {
            ...
            backImageView.image = UIImage(named: "card back highlighted_Kid.png")
