...
var instructionToShowYouth = -1

class YouthUnpauseConfirmationViewController: UIViewController {
    ...
    @IBAction func unpauseButton(_ sender: Any) {
        ...
        performSegue(withIdentifier: "unpauseCheckToInstrYouth", sender: self)
