...
class YouthCardCollectionViewCell: UICollectionViewCell {
    ...
    func setCard(_ card: YouthCard) {
        if !card.greyedOut {
            self.card = card
            
            frontImageView.image = UIImage(named: card.imageName)
            backImageView.image = UIImage(named: "card back_Kid_Youth.png")
            ...
            backImageView.image = UIImage(named: "card back greyed out_Kid_Youth.png")
        }
    }
    ...
    func flip(phase: Int) {
        if phase != 5 && phase != 6 {
            ...
            backImageView.image = UIImage(named: "card back highlighted_Kid_Youth.png")
